        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 lg:p-8">
            ...
            <form onSubmit={generateActivity} className="space-y-6">
              ...
              {/* Activity Location */}
              <div>
                <label htmlFor="activityLocation" className="block text-sm font-medium text-emerald-700 mb-2">
                  Activity Location
                </label>
                <select
                  id="activityLocation"
              ...
              <div>
                <label htmlFor="desiredActivityLength" className="block text-sm font-medium text-emerald-700 mb-2">
                  Desired Activity Length
                </label>
                <select
              ...
              {/* Number of Children */}
              <div>
                <label htmlFor="numberOfChildren" className="block text-sm font-medium text-emerald-700 mb-2">
              ...
              <div>
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-3 h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-emerald-300 rounded"
                  />
              ...
              {parentInvolved && (
                <div>
                  <label htmlFor="availableTime" className="block text-sm font-medium text-emerald-700 mb-2">
              ...
              {/* Activity Type */}
              <div>
                <label htmlFor="activityType" className="block text-sm font-medium text-emerald-700 mb-2">
              ...
              <div className="border border-emerald-200 rounded-lg">
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 text-left text-emerald-700 font-medium hover:bg-emerald-50 transition-colors"
                >
                ...
                {showAdditional && (
                  <div className="p-4 border-t border-emerald-200 space-y-4">
                    {/* Personality */}
                    <div>
                      <label htmlFor="personality" className="block text-sm font-medium text-emerald-700 mb-2">
                        Personality Traits
                      </label>
                      <select
                        id="personality"
                    ...
                    {/* Interests */}
                    <div>
                      <label htmlFor="interests" className="block text-sm font-medium text-emerald-700 mb-2">
                    ...
                    {/* Child Dislikes */}
                    <div>
                      <label htmlFor="childDislikes" className="block text-sm font-medium text-emerald-700 mb-2">
                    ...
                    {/* Developmental Stage */}
                    <div>
                      <label htmlFor="developmentalStage" className="block text-sm font-medium text-emerald-700 mb-2">
                        Skills Focus
                      </label>
                      <select
                    ...
                    {/* Available Materials */}
                    <div>
                      <label htmlFor="availableMaterials" className="block text-sm font-medium text-emerald-700 mb-2">
                    ...
                    {/* Learning Goals */}
                    <div>
                      <label htmlFor="learningGoals" className="block text-sm font-medium text-emerald-700 mb-2">
                        Learning Goals
                      </label>
                      <textarea
                        id="learningGoals"
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-emerald-700 hover:bg-emerald-800 disabled:bg-emerald-400 text-white font-semibold py-3 px-6 rounded-lg transition-colors cursor-pointer disabled:cursor-not-allowed"
                >
                  {isGenerating ? (
                ...
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-6 py-3 border-2 border-emerald-700 text-emerald-700 font-semibold rounded-lg hover:bg-emerald-50 transition-colors cursor-pointer"
                >
                  Reset
                </button>
              </div>
                ...
                {generatedActivity.learningOutcomes && (
                  <div className="bg-white rounded-lg border border-emerald-200 shadow-sm">
                    <button
                      ...
                      className="w-full text-left p-4 font-semibold text-emerald-800 hover:bg-emerald-50 transition-colors cursor-pointer flex items-center justify-between rounded-lg"
                    >
                      ...
                      <svg 
                        className={`w-5 h-5 transform transition-transform ${showLearningOutcomes ? 'rotate-180' : ''}`}
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                ...
                {generatedActivity.tips && (
                  <div className="bg-white rounded-lg border border-emerald-200 shadow-sm">
                    ...
                    >
                      ...
                      <svg 
                        className={`w-5 h-5 transform transition-transform ${showTips ? 'rotate-180' : ''}`}
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                ...
                <div className="bg-emerald-50 p-4 rounded-lg border border-emerald-200">
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors cursor-pointer flex items-center justify-center"
                    >
                      <FontAwesomeIcon 
                    ...
                    <button
                      ...
                      className="flex-1 bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-3 px-4 rounded-lg transition-colors cursor-pointer flex items-center justify-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className="flex-1 border-2 border-emerald-700 text-emerald-700 font-semibold py-3 px-4 rounded-lg hover:bg-emerald-50 transition-colors cursor-pointer flex items-center justify-center"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
